...
## Current Status
- **Phase**: Live ISO squashfs pivot + desktop mode COMPLETE. WiFi: iw scan fallback + connection verification + EAP detection (f8300ce). 10 vendor families, ~55 WiFi modules. 62 tools, 13 suites. ISO READY FOR TEST.
