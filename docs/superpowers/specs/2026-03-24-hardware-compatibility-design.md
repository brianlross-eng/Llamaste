...
CONFIG_IOMMU_DEFAULT_DMA_LAZY=y  # NOT PASSTHROUGH — avoids silent memory corruption
...
# Intel LPSS MFD (parent driver for I2C/SPI on Kaby Lake+)
...
# CPU frequency
CONFIG_CPU_FREQ=y
CONFIG_CPU_FREQ_DEFAULT_GOV_SCHEDUTIL=y  # Modern scheduler-aware governor
CONFIG_X86_INTEL_PSTATE=y
CONFIG_RFKILL=y                          # Laptop WiFi/BT killswitches
